...
class JsonServiceTest extends Specification {
    def "toJson should convert object to JSON string"() {
        ...
        then:
        jsonString == '{"taxIdentifications":"1","address":"ul. Bukowinska 24d/1 02-703 Warszawa, Polska","name":"iCode Trust 1 Sp. z o.o","pensionInsurance":10,"healthInsurance":100}'
    }
